function [HxI_Rmap,HxI_Rsub]=gencorrmap(FCS,subid,cov,statspath,statename,cba,cbc)
...
if figflag==1
    ...
    SaveAsAtlasNii(homoxintraLIabsc_R,'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLIabs' '_R' '_map'],1)
    ...
    SaveAsAtlasNii(homoxintraLIabsc_R_thrd,'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLIabs' '_R' '_THRD'],1)
