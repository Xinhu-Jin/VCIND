function genbasexhe(FCS,subid,statspath,statename,hepath)
...
SaveAsAtlasNii(Homo_he_V,'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],'HomoFC_he',1)
...
SaveAsAtlasNii(LIabs_he_V,'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],'IntraFC_LIabs_he',1)
...
NiiProj2Surf([statspath,'/',statename,'HomoFC_he','.nii'],'inf','tri','hemi',[0 0.6]);
% NiiProj2Surf([statspath,'/',statename,'IntraFC_LI_he','.nii'],'inf','tri','hemi',[0 0.4]);
NiiProj2Surf([statspath,'/',statename,'IntraFC_LIabs_he','.nii'],'inf','tri','hemi',[0 0.6]);

SaveAsAtlasNii(Homo_he_V .*(Homo_he_P<(0.05/190)),'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],'HomoFC_he_thrd',1)
...
SaveAsAtlasNii(LIabs_he_V .*(LIabs_he_P<(0.05/190)),'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],'IntraFC_LIabs_he_thrd',1)
% 
...
NiiProj2Surf([statspath,'/',statename,'HomoFC_he_thrd','.nii'],'inf','tri','hemi',[0 0.6]);
% NiiProj2Surf([statspath,'/',statename,'IntraFC_LI_he_thrd','.nii'],'inf','tri','hemi',[0 0.4]);
NiiProj2Surf([statspath,'/',statename,'IntraFC_LIabs_he_thrd','.nii'],'inf','tri','hemi',[0 0.6]);
