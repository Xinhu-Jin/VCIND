function gencocpmap(S1_Rmap,S1_Rsub,S2_Rmap,S2_Rsub,statspath,statename,cba)
...
% 
% Z_hiL_map_thr=Z_hiL_map .* (P_hiL_map<0.5/190);
% Z_hiR_map_thr=Z_hiR_map .* (P_hiR_map<0.5/190);
% Z_hiLI_map_thr=Z_hiLI_map .* (P_hiLI_map<0.5/190);
Z_hiLIabs_map_thr=Z_hiLIabs_map .* (P_hiLIbas_map<0.5/190);

% SaveAsAtlasNii(Z_hiL_map,'/data/newjiao/Sharefolder/atlas/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraL' '_Z' '_map'],1)
% SaveAsAtlasNii(Z_hiR_map,'/data/newjiao/Sharefolder/atlas/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraR' '_Z' '_map'],1)
% SaveAsAtlasNii(Z_hiLI_map,'/data/newjiao/Sharefolder/atlas/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLI' '_Z' '_map'],1)
SaveAsAtlasNii(Z_hiLIabs_map,'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLIabs' '_Z' '_map'],1)

% SaveAsAtlasNii(Z_hiL_map_thr,'/data/newjiao/Sharefolder/atlas/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraL' '_Z' '_map_THRD'],1)
% SaveAsAtlasNii(Z_hiR_map_thr,'/data/newjiao/Sharefolder/atlas/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraR' '_Z' '_map_THRD'],1)
% SaveAsAtlasNii(Z_hiLI_map_thr,'/data/newjiao/Sharefolder/atlas/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLI' '_Z' '_map_THRD'],1)
SaveAsAtlasNii(Z_hiLIabs_map_thr,'/data/newjiao/Sharefolder/atlas/HCP_2mm/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLIabs' '_Z' '_map_THRD'],1)
